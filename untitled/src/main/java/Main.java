import DbManipulation.AddDb;
import DbManipulation.DeleteDb;
import DbManipulation.SelectDb;
...
public class Main {
    public static void main(String[] args) throws SQLException {
        Connection connect = DriverManager.getConnection("jdbc:sqlite:db_lu");
                        ...
                        switch (choice) {
                            case 1 -> {
                                ...
                                int choiceAdd = inAdd.nextInt();
                                    if (choiceAdd == 1) {
                                            try {
                                                statement.executeUpdate(AddDb.insertCar());
                                            ...
                                            try {
                                                statement.executeUpdate(AddDb.insertShop());
                                            ...
                                            try {
                                                statement.executeUpdate(AddDb.insertUser());
                            ...
                            case 3 -> {
                                ...
                                if (choiceDelete == 1) {
                                    try {
                                        ...
                                        System.out.println("Автомобили успешно удалены");
